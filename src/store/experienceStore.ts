...
const EXPERIENCE: IExperience[] = [
    ...
    },
    {
        ...
        title: 'OARO',
        description:
            "<p class='text-4xl md:text-base mb-5'>Éste ha sido por el momento el único trabajo que he realizado <span class='text-sky-600 font-bold'>100% en remoto</span>. Aprendí a ser muy autónomo para solucionar los diferentes problemas que me encontraba en las tareas que tenía asignadas.</p>",
        technologies: ['Php', 'Symfony', 'Mysql', 'Github'],
        show: 'show',
    },
    {
        id: 'e-005',
    ...
    },
    {
        ...
        title: 'Lombok',
        description:
            "<p class='text-4xl md:text-base mb-5'>Fue mi primer trabajo con clientes y con la presión que ello conlleva. Trabajamos con todo tipo de sectores y eso hacía que cada web se hiciera de una manera diferente aunque la mayoría de ellas las hacíamos con Wordpress.</p><p class='text-4xl md:text-base mb-5'>Mi reto era llegar a las <span class='text-sky-600 font-bold'>fechas de entrega</span>. Aprendí a <span class='text-sky-600 font-bold'>trabajar con los diferentes departamentos</span> en el proceso de la creación de una página web.</p>",
